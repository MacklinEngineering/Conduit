...
exports.app.use('/swagger-ui', swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(swaggerDocument));
    ...
    try {
        const options = {
            parameters: {
                ...
                SEARCH: `%${(_a = req.query.search) === null || _a === void 0 ? void 0 : _a.toString().toLowerCase()}%`,
            },
        };
...
exports.app.post('/profile/{pid}/article/{aid}', async (req, res) => {
    ...
    await articleCollection
        .insert(id, profile)
        .then((result) => { return res.send({ ...profile, ...result }); })
        .catch((e) => {
        return res.status(500).send({
            message: `Profile Insert Failed: ${e.message}`,
        });
