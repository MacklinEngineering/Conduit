...
//   },
//   /** Update user */
//   async update(event: { body: string; }) {
//     const authenticatedUser = await authenticateAndGetUser(event);
//     if (!authenticatedUser) {
//       return Util.envelop('Token not present or invalid.', 422);
//     }
...
//   getUserByUsername,
//   async getProfile(event: { pathParameters: { username: any; }; }) {
...
//   async follow(event: { pathParameters: { username: any; }; httpMethod: string; }) {
//     const authenticatedUser = await authenticateAndGetUser(event);
//     if (!authenticatedUser) {
//       return Util.envelop('Token not present or invalid.', 422);
//     }
...
//   async getFollowedUsers(aUsername: any) {
...
//   }).promise();
// }
// function getUserByUsername(aUsername: any) {
...
//   }).promise();
// }
// function getTokenFromEvent(event: { body?: string; headers?: any; }) {
//   return event.headers.Authorization.replace('Token ', '');
// }
// async function getProfileByUsername(aUsername: any, aAuthenticatedUser: { username: any; }) {
...
//   return profile;
// }
// async function authenticateAndGetUser(event: { body?: string | undefined; pathParameters?: { username: any; } | { username: any; }; httpMethod?: string; headers?: any; }) {
//   try {
